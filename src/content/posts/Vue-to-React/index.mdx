...
lang: 'ko'
cover: '../../../assets/images/koin-vue-to-react-migration-0.png'
slug: '/blog/koin-vue-to-react-migration'
hero:
  image:
    file: '../../../assets/images/koin-vue-to-react-migration-0.png'
---
...
<PackageVersion versions={[['react', '16.12'], ['vue', '2']]} />
</Aside>
...
![동아리에서 만든 학생 커뮤니티 서비스 KOIN](../../../assets/images/koin-vue-to-react-migration-1.png)
...
![Vue를 배우면서 느꼈었던 React](../../../assets/images/koin-vue-to-react-migration-3.png)
...
![`props` and event](../../../assets/images/koin-vue-to-react-migration-2.png)
...
![React 컴포넌트 간 통신모형](../../../assets/images/koin-vue-to-react-migration-4.png)
_굳이 표현하자면 이런 모형_
...
![Vue를 개발하게 되면 많이 볼 __ob__](../../../assets/images/koin-vue-to-react-migration-5.png)
