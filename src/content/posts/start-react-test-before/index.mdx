...
hero:
  image:
    file: '../images/start-react-testing-1-0.png'
---
...
![당시 작성한 테스트들(2020.06~2020.07)](../images/start-react-testing-1-1.png)
...
![Kent c. Dodds 씨가 만든 Testing Trophy](../images/start-react-testing-1-2.png)
...
![트로피 위로 올라갈 수록 비용이 많이 들고, 속도가 느려지고, 문제가 커진다는 것을 표현하고 있다](../images/start-react-testing-1-3.png)
...
![State of JS 2020의 테스트 부분](../images/start-react-testing-1-5.png)
...
![](../images/start-react-testing-1-6.png)
...
![chromatic에서 제시하는 Testing trophy](../images/start-react-testing-1-7.png)
