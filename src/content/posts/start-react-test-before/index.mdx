---
title: '테스트를 시작하기 전에(2021년)'
date: 2021-07-29T00:00:00
lastUpdated: 2024-12-13T00:00:00
description: CRA 기반 프로젝트에서 테스트 시작하기 전에 알아야 할 것들
lang: 'ko'
cover: '../../../assets/images/start-react-testing-1-0.png'
slug: '/blog/start-react-test-before'
hero:
  image:
    file: '../../../assets/images/start-react-testing-1-0.png'
---
import { Aside } from '@astrojs/starlight/components';
import PackageVersion from '@components/PackageVersion.astro';

<Aside type="caution">
이 글은 2021년에 작성되었습니다. 아래 버전 기준으로 작성되었으며, 현재 상황과 맞지 않을 수 있습니다.
<PackageVersion versions={[['react', '16.12'], ['jest', '25']]} />
</Aside>
...
![당시 작성한 테스트들(2020.06~2020.07)](../../../assets/images/start-react-testing-1-1.png)
...
![Kent c. Dodds 씨가 만든 Testing Trophy](../../../assets/images/start-react-testing-1-2.png)
...
> 출처: [Kent C. Dodds blog - The Testing Trophy and Testing Classifications](https://kentcdodds.com/blog/the-testing-trophy-and-testing-classifications)
...
![트로피 위로 올라갈 수록 비용이 많이 들고, 속도가 느려지고, 문제가 커진다는 것을 표현하고 있다](../../../assets/images/start-react-testing-1-3.png)
...
![Jest vs Karma + Mocha + Chai...](../../../assets/images/start-react-testing-1-4.png)
...
![State of JS 2020의 테스트 부분](../../../assets/images/start-react-testing-1-5.png)
...
![](../../../assets/images/start-react-testing-1-6.png)
...
`Testing-Library`는 JSDOM을 통해서 실제 DOM을 렌더링하도록 react 컴포넌트를 가져와서 render함수를 통해 mount해서 사용하고 cleanup함수로 지우는 역할을 수행한다. `Testing-Library`는 `Enzyme`과 다르게 상태를 중심으로 확인하지 않고 올바른 결과나 DOM이 나왔는지 확인하는 행동 주도 테스트(Behavior Driven Test, 어플리케이션의 결과를 중점으로 테스트하는 것)에 적합하다고 한다. 보통 `@testing-library/react`와 생태계로 있는 `@testing-library/user-event`와 `@testing-library/jest-dom`을 같이 쓴다.

> 출처: [daleseo blog - React Testing Library 소개](https://www.daleseo.com/react-testing-library/)
...
![chromatic에서 제시하는 Testing trophy](../../../assets/images/start-react-testing-1-7.png)

Vitest, Storybook, Playwright... 여러가지 테스트 툴이 발전하면서 쉽게 테스트를 적용할 수 있다. 하지만 여전히 테스트의 종류를 이해하고 적절한 테스트를 적용하는 것은 필요해보인다.

### 또 다른 자료들의 출처

- [logrocket blog - React 테스트 라이브러리 비교](https://blog.logrocket.com/comparing-react-testing-libraries/)
- [Kent C. Dodds blog - 테스트 종류 비교](https://kentcdodds.com/blog/static-vs-unit-vs-integration-vs-e2e-tests)
- [NHN Meetup - 테스트 전략](https://meetup.toast.com/posts/174)