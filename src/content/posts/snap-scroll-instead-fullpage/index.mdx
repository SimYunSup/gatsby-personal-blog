...
hero:
  image:
    file: '../images/snap-scroll-instead-fullpage-0.png'
---
...
![구현하고 싶었던 Scroll snap(fullpage.js)](../images/snap-scroll-instead-fullpage-1.gif)
...
![fullpage.js 가격표](../images/snap-scroll-instead-fullpage-2.png)
...
![사람들이 안 쓰는데 이유가 있다](../images/snap-scroll-instead-fullpage-3.png)
...
![왼쪽 Firefox 78, 오른쪽 Chrome 84의 Snap Scroll 구현 비교](../images/snap-scroll-instead-fullpage-4.gif)
...
![mandatory와 proximity의 차이(좌: mandatory, 우: proximity)](../images/snap-scroll-instead-fullpage-6.gif)
...
![첫번째 시도의 Firefox 78에서의 테스트](../images/snap-scroll-instead-fullpage-8.gif)
...
![두번째 시도의 테스트(왼쪽은 Firefox 78, 오른쪽은 Chrome 84)](../images/snap-scroll-instead-fullpage-9.gif)
...
![세번째 시도의 테스트(왼쪽은 Firefox 78, 오른쪽은 Chrome 84)](../images/snap-scroll-instead-fullpage-10.gif)
