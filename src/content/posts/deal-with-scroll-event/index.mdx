...
![애플 제품 소개 페이지의 Scroll Interaction(Scroll Tracking)](../images/deal-with-scroll-event-01.gif)

![리디북스 홈페이지의 Lazy loading](../images/deal-with-scroll-event-02.gif)

![Pinterest의 Infinite Scroll](../images/deal-with-scroll-event-03.gif)
...
![Throttling 결과](../images/deal-with-scroll-event-04.png)
...
![Throttling 결과](../images/deal-with-scroll-event-05.png)
...
[![브라우저 렌더링 원리 다이어그램(클릭 시 출처로 이동)](../images/deal-with-scroll-event-06.png)](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/)

유명한 그림이지만 2011년에 나온 그림이다. 꽤 오래된 그림이므로 새로운 그림으로 바꿔보았다.

[![간단화된 브라우저 렌더링 원리(클릭 시 출처로 이동)](../images/deal-with-scroll-event-07.png)](https://web.dev/rendering-performance/)
...
![프레임의 라이프사이클](../images/deal-with-scroll-event-11.png)

## Event loop와 requestAnimationFrame

`requestAnimationFrame`에 보낸 callback이 어디에서 저장되는지 살펴보면 아래와 같다.

![이벤트 루프 다이어그램](../images/deal-with-scroll-event-12.png)
...
![복잡한 렌더링 사이클](../images/deal-with-scroll-event-13.png)
...
![고속 스크롤 불가일 경우](../images/deal-with-scroll-event-14.png)
...
![패시브 핸들러일 경우 작동 방식](../images/deal-with-scroll-event-15.jpg)
